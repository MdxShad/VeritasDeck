...
from veritasdeck.utils.path_utils import (
...
# Get project root directory (parent of veritasdeck package)
...
def main():
    """Main entry point for VeritasDeck CLI."""
    parser = argparse.ArgumentParser(
        description="VeritasDeck - Auto-reuses checkpoints",
