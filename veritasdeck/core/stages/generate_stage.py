...
async def run_generate_stage(base_dir: Path, config_dir: Path, config: Dict) -> Dict:
    ...
    from veritasdeck.summary import PaperContent, GeneralContent, TableInfo, FigureInfo, OriginalElements
    from veritasdeck.generator import GenerationConfig, GenerationInput
    from veritasdeck.generator.config import OutputType, PosterDensity, SlidesLength, StyleType
    from veritasdeck.generator.content_planner import ContentPlan, Section, TableRef, FigureRef
    from veritasdeck.generator.image_generator import ImageGenerator, save_images_as_pdf
