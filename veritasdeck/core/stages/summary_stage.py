...
async def run_summary_stage(base_dir: Path, config: Dict) -> Dict:
    ...
    from veritasdeck.summary import extract_paper, extract_general, extract_tables_and_figures, OriginalElements
    from veritasdeck.summary.paper import extract_paper_metadata_from_markdown
