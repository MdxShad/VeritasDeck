...
async def run_rag_stage(base_dir: Path, config: Dict) -> Dict:
    ...
    if fast_mode:
        ...
        from veritasdeck.raganything.batch_parser import BatchParser
        from veritasdeck.rag import RAG_PAPER_QUERIES
    ...
    # ========== NORMAL MODE: Full RAG pipeline ==========
        ...
        from veritasdeck.rag import RAGClient, RAG_PAPER_QUERIES, RAG_QUERY_MODES
        from veritasdeck.rag.query import get_general_overview, generate_general_queries
        from veritasdeck.rag.config import RAGConfig
