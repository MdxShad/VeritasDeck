"""
FastAPI server for VeritasDeck
"""
...
# Add parent directory to path to import veritasdeck modules
SCRIPT_DIR = Path(__file__).parent
PROJECT_ROOT = SCRIPT_DIR.parent
sys.path.insert(0, str(PROJECT_ROOT))

# Import veritasdeck functions
from veritasdeck.core import (
    run_pipeline, get_base_dir, get_config_dir,
    get_config_name, detect_start_stage
)
from veritasdeck.utils.path_utils import get_project_name
from veritasdeck.utils import setup_logging
...
app = FastAPI(title="VeritasDeck API", version="1.0.0")

# Configure logging for veritasdeck
...
@app.get("/")
async def root():
    return {"message": "VeritasDeck API Server", "status": "running"}
...
async def generate_slides_with_pipeline(
    ...
    """
    Run the actual VeritasDeck pipeline
    ...
    from veritasdeck.core.state import create_state, save_state, STAGES
...
def _update_state_on_error(
    ...
    from veritasdeck.core.state import load_state, save_state
    import json
...
async def get_status(session_id: str):
    ...
    try:
        ...
        from veritasdeck.core.paths import get_base_dir
        import json
...
if __name__ == "__main__":
    ...
    print("Starting VeritasDeck API server...")
